...
def main() -> int:
    ...
    print("Column key (all DINOv2/CLIP cosines, 0-1 scale):")
    print("  identity     mean DINOv2 cosine, every render vs every --reference-dir image")
    print("  cross_seed   mean DINOv2 cosine among same-prompt renders at different seeds")
    print("  flexibility  1 - mean DINOv2 cosine among different-prompt renders (one seed each)")
    print("  clip_score   mean CLIP image-text cosine between a render and its own prompt")
