...
| `01_dataset_hygiene.cmd` | `<image_folder>` [extra profiler flags — defaults `--recursive --min-side 1024`, yours win] |
...
| `03_train_style_sdxl.cmd` / `03_train_style_sd15.cmd` | same, with `style_concepts.json` |
