...
Four competing character-LoRA recipes ("arms") trained on the same 55-image anime
character dataset (plus its contrastive copy: 110 items → 27 steps/epoch at batch 4),
1188 steps each, checkpoints every 100
